...
function Trackball(mode){
   ...
   this.interpolate = function(xPos, yPos){
      ...
      var leftEdge     = document.getElementById('scene')
                                 .getBoundingClientRect()
                                 .left;
      var topEdge      = document.getElementById('scene')
                                 .getBoundingClientRect()
                                 .top;
      
      // Map the coordinates of where the moused was clicked to
      // the interval [-1, 1] in the horizontal and vertical directions.      
